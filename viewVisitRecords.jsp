    ...
    <%
        ...
        try {
            ...
            if (deleteId != null && !deleteId.isEmpty()) {
                ...
                if (rowsDeleted > 0) {
                    out.println("<p style='color:green; text-align:center;'>Visit record deleted successfully!</p>");
                } else {
                    out.println("<p style='color:red; text-align:center;'>Failed to delete visit record.</p>");
                }
            }
            ...
            if (!rs.isBeforeFirst()) {
                out.println("<p class='no-records'>No visit records found. <a href='addVisit.jsp'>Add a new visit</a></p>");
            } else {
    %>
